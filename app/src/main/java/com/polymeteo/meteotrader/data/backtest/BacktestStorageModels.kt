...
data class BacktestRecord(
    ...
    val rawEdge: Double? = null,
    val executableEdge: Double? = null,
    val fillProbabilityEstimate: Double? = null,
    val feeCostEstimate: Double? = null,
    val spreadCostEstimate: Double? = null,
    val liquidityCostEstimate: Double? = null,
    val totalCostEstimate: Double? = null,
    ...
    val expectedPnlUnits: Double? = null,
    val executionGapUnits: Double? = null,
    val fillProbabilityUsed: Double? = null,
    val fillDraw: Double? = null,
    val entryPriceUnits: Double? = null,
    val entryFeeUnits: Double? = null,
    val entrySlippageUnits: Double? = null,
    val exitPayoutUnits: Double? = null,
