...
data class BacktestReport(
    ...
    val expectedPnlUnits: Double,
    val executionGapUnits: Double,
    val guardrailDayUtc: LocalDate?,
    val guardrailKillSwitchActive: Boolean,
    val guardrailDailyPnlUnits: Double?,
    val guardrailConsecutiveLosses: Int?,
    ...
    companion object {
        fun empty(now: Instant = Instant.now()): BacktestReport {
            return BacktestReport(
                ...
                guardrailDayUtc = null,
                guardrailKillSwitchActive = false,
                guardrailDailyPnlUnits = null,
                guardrailConsecutiveLosses = null,
                avgPnlUnits = null,
                roi = null,
                hitRate = null,
